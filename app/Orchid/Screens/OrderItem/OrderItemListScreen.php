...
class OrderItemListScreen extends Screen
{
    ...
    {
        return [
            'orderItems' => OrderItem::join('orders', 'order_items.order_id', '=', 'orders.id')->where('orders.city_id', City::getPlatformCity())->filters()->filters(OrderItemFiltersLayout::class)->paginate(),
        ];
    }
