...
<div class="container valign-wrapper auth-container center">
    <div class="main-color center auth-inner message-wrapper">
        ...
        <p class="white-text">{{__('translations.Click link below to reset password')}}</p>
        <a href="{{route('resetPassword', $iin . 'pixelrental' . $token)}}"
           class="btn btn-large orange darken-4 white-text">{{__('translations.Restore password')}}</a>
    </div>
</div>
</body>
</html>
