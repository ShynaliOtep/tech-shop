...
<!--        <div v-if="!isCartEmpty" class="cart-page" style="display: none">-->
<!--            &lt;!&ndash; Loading Component &ndash;&gt;-->
...
<!--                                <div class="circle">-->
<!--                                    <div class="option-circle-in"></div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                            <div class="gap-patch">-->
...
<!--            &lt;!&ndash; Указать начало и конец аренды на все товары &ndash;&gt;-->
...
<!--                        &lt;!&ndash;  @foreach($items as $item) &ndash;&gt;-->
<!--                        &lt;!&ndash; FOR cartItems in cart &ndash;&gt;-->
...
<!--                                &lt;!&ndash;  Кнопка - + и количества &ndash;&gt;-->
...
<!--                                &lt;!&ndash; Текст для доступности &ndash;&gt;-->
...
<!--                                &lt;!&ndash; Указать время для каждого товара &ndash;&gt;-->
...
<!--        </div>-->
    ...
    <div v-if="modal.open && isAuthenticated" id="modal" class="modal"
        ...
        <div class="black-block simple-centred-block modal-block ">
            ...
            <button class="orange-btn order-disabled" @click="orderEvent()">
                {{ $t('translations.Place order') }}
            </button>
        </div>
