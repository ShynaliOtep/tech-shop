<template>
    <div>
        ...
        <div v-if="!isCartEmpty">
                ...
                <div class="col s12 m6">
                    ...
                    <form action="#">
                        <p>
                            <label>
                                <input
                                    @click="setRentType('all')"
                                    name="rent-type"
                                    type="radio"
                                    value="all"
                                />
                                <span
                                    >Я укажу время аренды для всех товаров
                                    сразу</span
                                >
                            </label>
                        </p>
                        <p>
                            <label>
                                <input
                                    @click="setRentType('individual')"
                                    name="rent-type"
                                    type="radio"
                                    value="individual"
                                />
                                <span
                                    >Я укажу время аренды для каждого
                                    товара</span
                                >
                            </label>
                        </p>
                    ...
                    <button
                        id="openModalBtn"
                        class="btn orange darken-4 btn-with-icon"
                    >
            ...
            <div
                v-if="rentType === 'all'"
                class="col s12 m9 goods-list-rent-type-all"
            >
                <div
                    class="col s6 input-field beginning-date-field-rent-type-all"
                >
                    <input
                        ...
                        @click="setMinEnd()"
                        type="date"
                        class="datepicker white-text beginning-date-rent-type-all"
                        required
                    />
                </div>
                <div
                    class="col s6 input-field white-text rent-starttime-field-rent-type-all"
                >
                    <select
                        ...
                        name="start_time"
                        class="datepicker white-text left rent-starttime-rent-type-all"
                        required
                    >
                        <option value="" disabled selected>
                            {{ $t("translations.Choose time") }}:
                        </option>
                        <option v-for="(item, key) in timeItems" :value="item">
                            {{ item }}
                        </option>
                    </select>
                </div>
                <div class="col s6 input-field ending-datefield-rent-type-all">
                    <input
                        ...
                        name="rent_end_date"
                        type="date"
                        class="datepicker white-text endingdate-rent-type-all"
                        required
                    />
                </div>
                <div
                    class="col s6 input-field white-text rent-endtime-field-rent-type-all"
                >
                    <select
                        name="end_time"
                        ...
                        class="datepicker white-text left rent-end-time-rent-type-all"
                        required
                    >
                        <option value="" disabled selected>
                            {{ $t("translations.Rent end") }}
                            :
                        </option>
                        <option v-for="(item, key) in timeItems" :value="item">
                            {{ item }}
                ...
                <ul
                    class="grey darken-4 additionals-outerwrapper-rent-type-all hide"
                >
                    <li>
                        ...
                        <div
                            class="grey darken-4 additionalswrapper-rent-type-all"
                        ></div>
                    </li>
                </ul>
            </div>
            ...
            <div class="row client-discount-holder">
                <div
                    class="col s12 m3 additional-info white-text hide-on-med-and-up hide"
                >
                    <span class="grey-text"
                        ><u>{{
                            $t("translations.Select rental periods for goods")
                        }}</u></span
                    >
                    <p>
                        {{
                            $t(
                                "translations.All items that you have added to your cart are listed here.",
                            )
                        }}
                    </p>
                    <p>
                        {{
                            $t(
                                "translations.Check each of them for compliance, and, if necessary, remove unnecessary ones.",
                            )
                        }}
                    </p>
                    <p>
                        <a class="orange-text text-darken-4" href="/"
                            ><b
                                ><u>{{ $t("translations.to main page") }}</u></b
                            ></a
                        >.
                    </p>
                    <hr />
                    <p>
                        <b>{{ $t("translations.IMPORTANT!") }}</b>
                    </p>
                    <p>
                        {{
                            $t(
                                "translations.Be sure to keep in mind that if you rent equipment and it breaks down, an additional payment will apply, Based on the terms of the contract",
                            )
                        }}
                    </p>
                    <p>
                        {{
                            $t(
                                "translations.Please note: For late payment of payments specified in the agreement, the Lessor has the right require the Tenant to pay a penalty in the amount of 5% of the unpaid payment for each day delays",
                            )
                        }}
                    </p>
                    <hr />
                ...
                <div class="col s12 m9 goods-list">
                    <form method="POST" id="order-placement-form">
                        ...
                        <div
                            ...
                            class="row no-margin good-wrapper"
                            :key="index"
                        >
                            <!-- IMAGE -->
                            <div class="col s5 m3 good-cart-image center">
                                <img
                                    src="{{good.attachment?.url}}"
                                    alt=""
                                    class="good-image"
                                />
                            </div>
                            ...
                            <!-- Good info block -->
                            <div
                                class="col s7 m9 good-cart-additional-info white-text"
                            >
                                <p>
                                    {{ $t("translations.Name") }}:
                                    <a href="/{{good.id}}"
                                ...
                                <p
                                    v-if="
                                        good.discount_cost &&
                                        good.discount_cost !== 0
                                    "
                                >
                                    {{ $t("translations.Cost for day") }}:
                                    <s>{{ good.cost }}</s>
                                    <b class="orange-text text-darken-4">{{
                                        good.discount_cost
                                    }}</b>
                                ...
                                <!--  Кнопка - + и количества -->
                                <div
                                    class="add-to-cart-btn waves-effect waves-light orange darken-4 good-add-to-card"
                                >
                                    <span
                                    ...
                                    >
                                        <i
                                            ...
                                            class="delete tiny material-icons"
                                            >delete</i
                                        >
                                        <span v-else>-</span>
                                    </span>
                                ...
                                <p
                                    v-if="good.availableItems == null"
                                    class="info-for-items-label"
                                >
                                    У каждого варианта свое свободное время!
                                </p>
                                <p
                                    v-if="
                                        good.availableItems === false &&
                                        good.availableItemsQuantity === 0
                                    "
                                    class="info-for-items-label"
                                >
                                    На выбранную дату нет свободные варианты
                                </p>
                                <p
                                    v-if="
                                        good.availableItems === false &&
                                        good.availableItemsQuantity <
                                            good.quantity
                                    "
                                    class="info-for-items-label"
                                >
                                ...
                                <div
                                    class="col s12 input-field white-text hide {{index}}"
                                ></div>

                                <!-- Указать время для каждого товара -->
                                <div v-if="rentType === 'individual'">
                                    <div
                                        class="col s6 input-field begining-date-field"
                                    >
                                        <input
                                            v-model="
                                                this.cart[index].date.dateStart
                                            "
                                    ...
                                    <div
                                        class="col s6 input-field white-text rent-start-time-field"
                                    >
                                        <select
                                            style="margin-bottom: 8px"
                                        ...
                                        >
                                            <option value="" disabled selected>
                                                {{
                                                    $t(
                                                        "translations.Choose time",
                                                    )
                                                }}:
                                            </option>
                                            <option
                                                v-for="(item, key) in timeItems"
                                                :value="item"
                                            >
                                                {{ item }}
                                            </option>
                                    ...
                                    <div
                                        class="col s6 input-field ending-date-field"
                                    >
                                        <input
                                    ...
                                    <div
                                        class="col s6 input-field white-text rent-end-time-field"
                                    >
                                        <select
                                            name="end_time [{{index}}]"
                                ...
                                <!-- Блок ДОП. товары -->
                                <ul
                                    class="grey darken-4 additionals-outer-wrapper"
                                >
                                    <li>
                                        <div
                                            class="grey darken-4"
                                        ...
                                        >
                                            <p>
                                                {{
                                                    $t(
                                                        "translations.Additional accessories",
                                                    )
                                                }}:
                                            </p>
                                        </div>
                                        <div
                                            class="grey darken-4 additionals-wrapper"
                                            v-if="good.additions"
                                        >
                                            <div
                                                v-for="(
                                                    addition, additionalIndex
                                                ) in good.additions"
                                            >
                                                <label>
                                                    <input
                                                ...
                                                <p
                                                    v-if="
                                                        addition.availableQuantity ==
                                                        null
                                                    "
                                                    class="info-for-items-label"
                                                >
                                                    У каждого варианта свое
                                                    свободное время!
                                                </p>
                                                <p
                                                    v-if="
                                ...
                                <div class="control-sum right">
                                    <h5 v-if="good.sumPrice > 0" class="inline">
                                        {{ $t("translations.Total") }}:
                                        <span class="good-cost-holder">
                                            {{ good.sumPrice }}
                                        </span>
                                        {{ $t("translations.KZT") }}
                                    </h5>
                ...
                ÷
                <div
                    class="col s12 m3 additional-info white-text hide-on-med-and-down hide"
                >
                    <span class="grey-text"
                        ><u>{{
                            $t("translations.Select rental periods for goods")
                ...
                <div
                    ...
                    id="total-sum-of-items"
                    v-if="endAvailable === true"
                >
                    <h5 class="white-text">
                        Итого:
                        <span class="total-cost-holder">{{ sumPrice }}</span>
                        {{ $t("translations.KZT") }}
                    </h5>
                    <p
                        class="white-text"
                        v-if="
                            clientData &&
                            clientData.bonusPercent &&
                            clientData.bonusPercent > 0
                        "
                    >
                        Бонус после покупки:
                        <span class="bonus-holder">{{ bonusAmount }}</span>
                        {{ $t("translations.KZT") }}
                    </p>
                </div>
                <div class="col s12 right-align">
                    <div
                        @click="modalOrder"
                        href="#order-placement-modal"
                        :class="!endAvailable ? 'disabled' : ''"
    ...
    <div v-if="isCartEmpty">
        <h4 class="white-text center">
            {{ $t("translations.There is nothing here yet") }} :(
        </h4>
        <h5 class="white-text center">
            {{ $t("translations.Get back to") }}
            ...
            >,
            {{ $t("translations.and") }}
            {{ $t("translations.add anything you like to your cart") }}
        </h5>
    </div>
    <div
        v-if="modal.open && !isAuthenticated"
        class="modal bottom-sheet custom-modal open"
        style="
            z-index: 1003;
            display: block;
            opacity: 1;
    ...
    >
        <div class="modal-content container center">
            <h1 class="btn-floating btn-large orange darken-4">
                <i class="large material-icons text-accent-4 white-text">{{
                    "favorite_border"
                }}</i>
            </h1>
            ...
            <p>
                {{
                    $t(
                        "translations.Please enter to your account to continue order settlement",
                    )
                }}
            </p>
        </div>
        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col s12 center">
                    <a
                        href="/auth/login"
                        class="btn-large nav-link orange darken-4 auth-link"
                    >
                ...
                <div class="col s12 center">
                    <a
                        href="/auth/register"
                        class="btn-large modal-btn grey black white-text register-link"
                        >{{ $t("translations.Register") }}</a
                    >
                </div>
            </div>
        </div>
    ...
    >
        <div class="modal-content container center">
            <h4>
                {{
                    $t(
                        "translations.Are you sure you are ready to place an order?",
                    )
                }}
            </h4>
            <p>
                {{
                    $t(
                        "translations.After confirming your order, your order will be transferred to the manager and you will be able to receive your goods at the pick-up point at",
                    ) + ":"
                }}
            </p>
            <p>
            ...
            <p>
                {{
                    $t(
                        "translations.The manager will double-check your contact details and photographs of your ID, after which an equipment rental agreement will be signed",
                    ) + "."
                }}
            </p>
        </div>
        ...
        <div class="modal-footer">
            <div class="row center">
                ...
                <button
                    class="btn-large nav-link orange darken-4 auth-link confirm-order-btn"
                    @click="orderEvent()"
                >
                    {{ $t("translations.Place order") }}
    ...
    methods: {
        ...
        async getCart() {
            ...
            items.forEach((item) => {
                ...
                item.additions = [];
                item.addedAdditions = [];
                item.sumCost = item.discount_cost
                    ? item.discount_cost * item.quantity
        ...
        addedAdditional(index, additionalGoodId) {
            for (let i = 0; i < this.cart[index].addedAdditions.length; i++) {
                if (
                    this.cart[index].addedAdditions[i].goodId ===
                    additionalGoodId
                ) {
        ...
        calc(index) {
            ...
            let sumCost = cartItem.discount_cost
                ? cartItem.discount_cost * cartItem.quantity
                : cartItem.cost * cartItem.quantity;
            cartItem.additions.forEach((addition) => {
                if (addition.added === true) {
                    sumCost =
                        sumCost +
                        addition.good.additional_cost * addition.quantity;
                }
            });
        ...
        calcEnd() {
            ...
            if (this.clientData && this.clientData.bonusPercent) {
                this.bonusAmount =
                    (this.clientData.bonusPercent * sumPrice) / 100;
            }
        ...
        setSumPrice(index) {
            ...
            item.sumPrice =
                item.sumCost *
                this.diffInDays(item.date.dateStart, item.date.dateEnd);
            this.cart[index] = item;
        },
