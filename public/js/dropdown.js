    ...
    class Dropdown extends Component {
        constructor(el, options) {
            ...
            this._handleTriggerKeydownBound =
                this._handleTriggerKeydown.bind(this);
            ...
            if (e.which === M.keys.TAB) {
                ...
                do {
                    ...
                    if (
                        ...
                        this.dropdownEl.children[newFocusedIndex].tabIndex !==
                            -1
                    ) {
                        foundNewIndex = true;
                        break;
            ...
            if (letter && nonLetters.indexOf(e.which) === -1) {
                ...
                let string = this.filterQuery.join(""),
                    newOptionEl = $(this.dropdownEl)
                        ...
                        .filter((el) => {
                            return (
                                $(el).text().toLowerCase().indexOf(string) === 0
                            );
                        })[0];
        ...
        _getDropdownPosition(closestOverflowParent) {
            ...
            if (horizontalAlignment === "right") {
                idealXPos =
                    idealXPos - dropdownBRect.width + triggerBRect.width;
            }
            return {
                x: idealXPos,
                y: idealYPos,
        ...
        _placeDropdown() {
            ...
            let closestOverflowParent = M.getClosestAncestor(
                this.dropdownEl,
                (ancestor) => {
