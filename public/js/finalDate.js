    ...
    if (startDateInput && endDateInput) {
        ...
        if (diff > 0) {
            document.getElementById("final-date-counter").innerHTML =
                "Итоговое количество дней аренды: " + diff;
            document.getElementById("final-item-counter").innerHTML =
                "Общее количество товаров: " + totalCount.value;
            document.getElementById("final-price-counter").innerHTML =
                "Общее количество товаров: " + totalPrice.value * diff;
            confirmHolder.innerHTML = `<a href="#confirm-modal"
