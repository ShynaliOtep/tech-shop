        ...
        fetch("/remove-from-cart", {
            ...
            .then(() => {
                ...
                enableAllOtherOptions(
                    e.target.parentNode.parentNode.dataset.goodId,
                    e.target.parentNode.parentNode.dataset.goodItemId,
                );
            ...
            .then(() => {
                const amountOfDays =
                    e.target.parentNode.parentNode.parentNode.parentNode
                        .parentNode.parentNode.parentNode.dataset
                        .amountOfDays ?? 1;
                var discount = +document.querySelector(
                    ".client-discount-holder",
                ).dataset.discountPercent;
                const controlSumNode =
                    e.target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.querySelector(
                        ".good-cost-holder",
                    );
                if (isNaN(discount)) {
                    discount = 0;
                ...
                if (e.target.checked) {
                    controlSumNode.innerHTML =
                        +controlSumNode.innerHTML +
                        (+this.dataset.additionalCost / 100) *
                            (100 - discount) *
                            amountOfDays;
                    changeTotalCost(
                        (+this.dataset.additionalCost / 100) *
...
const modalTriggerButton = document.querySelector(
    ".btn.orange.darken-4.auth-link.valign-wrapper.next-step-btn.modal-trigger",
);
const itemTotalCostTextElement =
    document.querySelectorAll('h5[class="inline"]');
const mainFormElement = document.querySelector(".col.s12.m9.goods-list");
const informationalTextElement = document.querySelector(
    ".col.s12.m3.additional-info.white-text.hide-on-med-and-down",
);
const formRentTypeAll = document.querySelector(
    ".col.s12.m9.goods-list-rent-type-all.hide",
);
let rentStartDateV2 = "";
let rentStartTimeV2 = "";
let rentEndDateV2 = "";
...
const startDatepicker = document.querySelector(
    ".datepicker.white-text.beginning-date-rent-type-all.hide",
);
const startTimePicker = document.querySelector(
    ".white-text.left.rent-starttime-rent-type-all.hide",
);
const endDatePicker = document.querySelector(
    ".datepicker.white-text.endingdate-rent-type-all.hide",
);
const endTimePicker = document.querySelector(
    ".white-text.left.rent-end-time-rent-type-all.hide",
);
const startDatepickerDiv = document.querySelector(
    ".col.s6.input-field.beginning-date-field-rent-type-all.hide",
);
const startTimePickerDiv = document.querySelector(
    ".col.s6.input-field.white-text.rent-starttime-field-rent-type-all.hide",
);
const endDatePickerDiv = document.querySelector(
    ".col.s6.input-field.ending-datefield-rent-type-all.hide",
);
const endTimePickerDiv = document.querySelector(
    ".col.s6.input-field.white-text.rent-endtime-field-rent-type-all.hide",
);
                ...
                onSelect: async (e) => {
                    ...
                    endTimePicker.onchange = async (e) => {
                        try {
                            selectedItems = [];
                            isOrderAvailable =
                                selectedItems.length === availableItemsLength;
                            updateButtonState();
                            const additionalsWrapper =
                        ...
                        // mainFormElement.classList.remove('hide');
                        let itemIdPickers =
                            document.querySelectorAll(".item-id-selector");
                        itemIdPickers.forEach(async (item) => {
                            if (
                                item.parentNode.parentNode.classList.contains(
                                    "select-wrapper",
                                )
                            ) {
                                const baseWrapper =
                            ...
                            if (availableItems.length == 0) {
                                item.innerHTML =
                                    '<option value="" disabled selected>На выбранную дату нет свободных вариантов</option>';
                            } else {
                                item.innerHTML =
                                    '<option value="" disabled selected>Выберите вариант товара</option>';
                            ...
                            itemSelect.el.onchange = async (e) => {
                                const cost =
                                    e.target.parentNode.parentNode.parentNode
                                        .parentNode.parentNode.dataset.goodCost;

                                var startDate = new Date(
                                    rentStartDateV2 + " " + rentStartTimeV2,
                                );
                                var endDate = new Date(
                                    rentEndDateV2 + " " + rentEndTimeV2,
                                );
                                ...
                                e.target.parentNode.parentNode.parentNode.parentNode.parentNode.dataset.amountOfDays =
                                    differenceDays;
                                ...
                                await changeCartKey(
                                    e.target.dataset.goodId,
                                    selectedItemId,
                                    e.target.dataset.oldItemId,
                                );
                                await changeFieldsItemId(
                                    e.target,
                                    e.target.dataset.goodId,
                                    selectedItemId,
                                );
                                e.target.parentNode.parentNode.parentNode.parentNode.parentNode.dataset.goodItemId =
                                    selectedItemId;
                                if (e.target.dataset.oldItemId) {
                                    await enableAllOtherOptions(
                                        e.target.dataset.goodId,
                                        e.target.dataset.oldItemId,
                                    );
                                }
                                await disableAllOtherOptions(
                                    e.target.dataset.goodId,
                                    e.target.value,
                                );
                                ...
                                if (!selectedItems.includes(selectedItemText)) {
                                    ...
                                    for (
                                        ...
                                        const index =
                                            selectedItems[i].indexOf("|");
                                        const valuee = selectedItems[
                                            i
                                        ].substring(0, index);
                                        if (
                                            valuee ==
                                            ...
                                            classValue = valuee;
                                            classValueItem =
                                                selectedItems[i].split("|");
                                            classValueItem =
                                                classValueItem[1].trim();
                                        }
                                    }
                                    if (
                                        removeAfterParenthesis(
                                            classValueItem,
                                        ) ==
                                        removeAfterParenthesis(selectedItemText)
                                    ) {
                                        selectedItems[indexArray] =
                                            e.target.parentNode.parentNode
                                                .parentNode.className +
                                            "|" +
                                            selectedItemText;
                                ...
                                document.querySelector(
                                    "beginning-date-field-rent-type-all",
                                );
                                updateButtonState();
                                ...
                                try {
                                    ...
                                    additionalsWrapper.innerHTML = "";
                                    const additionalsOuterWrapper =
                                        e.target.parentNode.parentNode.parentNode.parentNode.parentNode.querySelector(
                                            ".additionals-outer-wrapper",
                                        );
                                    ...
                                    additionalsResponse.additionals.forEach(
                                        (additional) => {
                                    ...
                                    if (
                                        additionalsResponse.additionals.length >
                                        0
                                    ) {
                                        additionalsOuterWrapper.classList.remove(
                                            "hide",
                                        );
...
let bonusHolderLevelPercent = parseInt(
    document.querySelector("#client_bonus_level").innerHTML,
);
...
function fillIndividualRentType() {
    ...
    itemIdPickers.forEach(async (item) => {
        ...
        const availableItems = await fetch(
            "/good/" +
                item.parentNode.parentNode.parentNode.dataset.goodId +
                "/get-items",
            {
                method: "POST",
                headers: {
        ...
        itemSelect.el.onchange = async (e) => {
            ...
            if (rentTimeType === RENT_TIME_TYPE_INDIVIDUAL) {
                e.target.parentNode.parentNode.parentNode.parentNode
                    .querySelector(".begining-date-field")
                ...
                try {
                    ...
                    e.target.parentNode.parentNode.parentNode.parentNode
                        .querySelector(".rent-start-time-field")
                        .classList.add("hide");
                } catch (e) {}
                try {
                    const endingDateItem =
                        e.target.parentNode.parentNode.parentNode.parentNode.querySelector(
                            ".ending-date",
                        );
                    ...
                    e.target.parentNode.parentNode.parentNode.parentNode
                        .querySelector(".ending-date-field")
                        .classList.add("hide");
                } catch (e) {}
                try {
                    const rentEndItem =
                    ...
                    e.target.parentNode.parentNode.parentNode.parentNode
                        .querySelector(".rent-end-time-field")
                        .classList.add("hide");
                } catch (e) {}
                try {
                    e.target.parentNode.parentNode.parentNode.parentNode
                        .querySelector(".additionals-outer-wrapper")
                        .classList.add("hide");
                } catch (e) {}
                ...
                item.parentNode.insertAdjacentHTML("afterend", loaderElement);
                const forbiddenDates = await fetch(
                    "/item/" + selectedItemId + "/get-unavailable-dates",
                    {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
                ...
                instance.options.onSelect = async (e) => {
                    const rentStartItem =
                        instance.el.parentNode.parentNode.querySelector(
                            ".rent-start-time",
                        );
                    rentStartItem.value = null;
                    instance.el.parentNode.parentNode
                        .querySelector(".rent-start-time-field")
                        .classList.remove("hide");
                    try {
                        instance.el.parentNode.parentNode
                    ...
                    const responseData = await fetch(
                        "/item/" + selectedItemId + "/get-available-times",
                        {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                    ...
                    const nextUnavailableDate =
                        responseData.nextUnavailableDate;
                    selector.innerHTML =
                        '<option value="" disabled selected>Время начала</option>';
                    availableTimes.forEach((time) => {
                    ...
                    selector.onchange = async (e) => {
                        ...
                        const responseData = await fetch(
                            "/item/" + selectedItemId + "/get-rent-end-dates",
                            {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                            ...
                            .then((response) => {
                                e.target.parentNode.parentNode.parentNode.parentNode
                                    .querySelector(".loader-holder")
                                    .remove();
                                secondDatepicker.parentNode.classList.remove(
                                    "hide",
                                );
                                return response;
                            });
                        const availableRentEndDates =
                            responseData.availableDates;
                        const secondDatepickerInstance = M.Datepicker.init(
                            secondDatepicker,
                            {
                                i18n: {
                                    months: [
                                ...
                                disableDayFn: (date) => {
                                    if (availableRentEndDates.length > 0) {
                                        ...
                                        const year = date.getFullYear();
                                        const dateString = `${year}-${month}-${day}`;
                                        return !availableRentEndDates.includes(
                                            dateString,
                                        );
                                    }
                                    return false;
                                ...
                                onSelect: async (e) => {
                                    ...
                                    secondDatepickerInstance.el.parentNode.insertAdjacentHTML(
                                        "afterend",
                                        loaderElement,
                                    );
                                    ...
                                    const responseData = await fetch(
                                        ...
                                        .then((response) => {
                                            secondDatepickerInstance.el.parentNode.parentNode
                                                .querySelector(".loader-holder")
                                                .remove();
                                            endTimeSelector.parentNode.classList.remove(
                                                "hide",
                                            );
                                            return response;
                                        });
                                    const nextAvailableTimes =
                                        responseData.nextAvailableTimes;
                                    endTimeSelector.innerHTML =
                                        '<option value="" disabled selected>Время конца</option>';
                                    ...
                                    <label>
                                        ...
                                        <span>${additional.good.name_ru} <span
                                            ...
                                            if (
                                                additionalsResponse.additionals
                                                    .length > 0
                                            ) {
                                                additionalsOuterWrapper.classList.remove(
                                                    "hide",
        ...
        document
            .querySelector(
                rentTimeType === RENT_TIME_TYPE_INDIVIDUAL
                    ...
                    : "#order-placement-form-rent-type-all",
            )
            .submit();
        e.target.onclick = () => {};
    } else {
