    ...
    constructor({ sidebar, resizer, toggleButton }, ltr, isResizerOnTheLeft) {
        ...
        this.#resizeObserver = new ResizeObserver(
            ([
                ...
                if (!isNaN(this.#prevX)) {
                    this.#prevX +=
                        this.#coefficient * (inlineSize - this.#width);
                }
...
class CommentSidebar extends Sidebar {
    ...
    removeComments(ids) {
        ...
        if (
            new Set(this.#idsToElements.keys()).difference(new Set(ids))
                .size === 0
        ) {
            this.#removeAll();
            return;
    ...
    #setText(element, richText, contentsObj) {
        ...
        const html =
            richText?.str &&
            (!contentsObj?.str || richText.str === contentsObj.str)
                ? richText.html
                : contentsObj?.str;
        renderRichText(
            {
        ...
        if (editor.hasDefaultPopupPosition()) {
            ...
            if (parentDimensions) {
                if (
                    ...
                    const buttonWidth =
                        this.#editor.commentButtonWidth *
    ...
    _finishRendering(fragment, count, hasAnyNesting = false) {
        if (hasAnyNesting) {
            ...
            this.container.addEventListener("click", (e) => {
                ...
                if (e.shiftKey) {
                    const shouldShowAll =
                        !target.classList.contains("treeItemsHidden");
                ...
                if (typeof groupId === "object") {
                    ...
                    label.append(
                        ...
                        document.createTextNode(
                            this._normalizeTextContent(group.name),
                        ),
                    );
...
class PDFPageView extends BasePDFPageView {
    ...
    reset({
        ...
        for (let i = childNodes.length - 1; i >= 0; i--) {
            ...
            if (
                keepPdfBugGroups &&
                node.classList.contains("pdfBugGroupsLayer")
            ) {
                continue;
            }
            node.remove();
...
class SignatureManager {
    ...
    constructor(
        ...
        SignatureManager.#l10nDescription ||= Object.freeze({
            ...
            errorUploadTitle:
                "pdfjs-editor-add-signature-image-upload-error-title",
            errorUploadDescription:
                "pdfjs-editor-add-signature-image-upload-error-description",
            errorNoDataTitle:
                "pdfjs-editor-add-signature-image-no-data-error-title",
...
class ViewsManager extends Sidebar {
    ...
    constructor({
        ...
        this.viewsManagerCurrentOutlineButton =
            viewsManagerCurrentOutlineButton;
    ...
    switchView(view, forceOpen = false) {
        ...
        this.viewsManagerCurrentOutlineButton.hidden =
    ...
    async _initializeViewerComponents() {
            ...
            AppOptions.get("enableComment") && appConfig.editCommentDialog
                ? new CommentManager(
                      appConfig.editCommentDialog,
                      {
                          ...
                          sidebar:
                              appConfig.annotationEditorParams
                                  ?.editorCommentsSidebar || null,
                          sidebarResizer:
                              appConfig.annotationEditorParams
                                  ?.editorCommentsSidebarResizer || null,
                          commentsList:
                              appConfig.annotationEditorParams
                                  ?.editorCommentsSidebarList || null,
                          commentCount:
                              appConfig.annotationEditorParams
                                  ?.editorCommentsSidebarCount || null,
                          sidebarTitle:
                              appConfig.annotationEditorParams
                                  ?.editorCommentsSidebarTitle || null,
                          closeButton:
                              appConfig.annotationEditorParams
        ...
        if (appConfig.annotationEditorParams) {
            if (annotationEditorMode !== AnnotationEditorType.DISABLE) {
                ...
                const editorCommentButton =
                    appConfig.toolbar?.editorCommentButton;
...
function getViewerConfiguration() {
    return {
        ...
        addSignatureDialog: {
            ...
            errorDescription: document.getElementById(
        ...
        annotationEditorParams: {
            editorCommentsSidebar: document.getElementById(
